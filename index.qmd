...
# Tutorial Breve: Muestreo Ponderado de Lecturas FASTQ para Ensamblaje Genómico

Este tutorial explica concisamente dos scripts: un Python para muestreo ponderado de lecturas largas basado en calidad, y un Bash para preparar y ejecutar dicho muestreo ajustado a cobertura objetivo (e.g., 100x) en un ensamblaje.

...
Vamos a eliminar el 5 % inferior de las lecturas fastq peores.
...
Y otro archivo en bash al que llamaremos `RUN_sample_100x.sh`.

```{bash, eval=FALSE}
# variables (ajusta rutas/hilos si quieres)
...
# aquí supongo PLASMID_THRESHOLD=10000 como antes
...
# ejecutar el script (ajusta qpower si quieres)
